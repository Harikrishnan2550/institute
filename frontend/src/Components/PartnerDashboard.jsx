      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 flex items-center justify-center">
        <div className="text-center">
          <div className="relative inline-block">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 border-4 border-purple-500/30 border-b-purple-500 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '0.8s' }}></div>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 p-4 sm:p-6 lg:p-8">
      ...
      <div className="relative mb-10 sm:mb-14">
        <div className="flex items-center gap-4 mb-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-2xl shadow-indigo-500/50 animate-pulse">
            <span className="text-3xl">👋</span>
          </div>
          <div>
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-black bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
              Welcome Back, Partner
            </h1>
            <p className="text-indigo-300/80 mt-2 text-sm sm:text-base font-medium">
      ...
      <div className="relative bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-6 sm:p-8 shadow-2xl">
        ...
        <h2 className="relative text-2xl sm:text-3xl font-bold text-white flex items-center gap-3 mb-8">
          <span className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-lg shadow-indigo-500/50">
            ⚡
          </span>
          Quick Actions
        </h2>
        ...
        {partnerLink && (
          <div className="relative mt-10 border-t border-white/10 pt-8">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-5 flex items-center gap-3">
              <span className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-lg shadow-indigo-500/50">
                🔗
              </span>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="relative w-full sm:flex-1 group">
                <input
                  ...
                  value={partnerLink}
                  readOnly
                  className="w-full px-5 py-4 border-2 border-white/20 rounded-2xl text-white bg-white/5 backdrop-blur-sm font-mono text-sm focus:outline-none focus:border-indigo-500 focus:bg-white/10 transition-all shadow-lg"
                />
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-indigo-500/0 via-purple-500/10 to-pink-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
              </div>
              <button
                onClick={copyLink}
                className="group relative px-8 py-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:via-purple-500 hover:to-pink-500 text-white font-bold rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl shadow-indigo-600/50 hover:shadow-2xl hover:shadow-purple-500/60 overflow-hidden whitespace-nowrap"
              >
            ...
            <p className="text-indigo-300/80 text-sm sm:text-base mt-4 flex items-start gap-2 bg-white/5 rounded-xl p-4 border border-white/10">
  ...
  return (
    <div className={`group relative bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 overflow-hidden transform transition-all duration-500 hover:scale-105 hover:bg-white/10 shadow-2xl ${shadowColors[accentColor]}`}>
      <div className="relative z-10 p-6 sm:p-7">
        ...
        <h3 className="text-indigo-300/70 text-xs sm:text-sm font-bold uppercase tracking-widest mb-3">
          {title}
        </h3>
        <p className="text-4xl sm:text-5xl font-black text-white mb-2 transition-all duration-300 group-hover:scale-105">
          ₹{value?.toLocaleString() || 0}
        </p>
        <div className="h-1 w-16 rounded-full bg-gradient-to-r from-transparent via-white/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
      </div>
